...
class LinearRegression:
    ...
    def get_gradient(self):
        ...
        numerator = sum((self.x[i] - self.x_mean) * (self.y[i] - self.y_mean) for i in range(len(self.x)))
    ...
    def r_squared(self):
        ...
        sum_squared_error = sum((self.expected_y() - self.y) ** 2)
...
class ExponentialRegression:
    ...
    def future_value(self, year):
        ...
        return np.e * (self.m * year + self.c)
